...
iarduino_RTC watch(RTC_DS1302, 8, 9, 10);                            // Объявляем объект watch для работы с RTC модулем на базе чипа DS1302, указывая выводы Arduino подключённые к выводам модуля RST, CLK, DAT.
...
void loop() {                                                           //
  if (millis() % 1000 == 0) {                                         // Если прошла 1 секунда.
    ...
    */
    ...
    big.writeint(0, 1, h, 1, false);
    big.writeint(0, 4, m, 2, true);
    big.writeint(0, 10, s, 2, true);
